...
const userQuery = "Book an appointment for Raju with Dr. Naruto singh today afternoon";
...
async function run() {
  ...
  console.log("--- Executing Booking Test ---");
  ...
  if (result.intent === "book_appointment") {
     console.log("SUCCESS: booking intent identified!");
  } else {
     console.log("FAILURE: Not a booking intent");
  }
